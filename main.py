    ...
    def download(self):
        ...
        for feature in data['features']:
            ...
            if geometry['type'] == 'Polygon':
                coords = geometry['coordinates'][0]  # Pegue as coordenadas do polígono principal
                for coord in coords:
        ...
        for feature in data['features']:
            geometry = feature['geometry']
            if geometry['type'] == 'Polygon':
                coords.extend(geometry['coordinates'][0])  # Adicione as coordenadas do polígono principal
...
if __name__ == "__main__":
    ...
    processor.set_date("2023-03-15", "2023-05-15")
